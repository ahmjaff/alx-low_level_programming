C - argc, argv
In this project, I learned about utilizing arguments passed to C functions with argc and argv as well as how to use _attribute_((unused)) or void to compile functions with unused variables or parameters.
